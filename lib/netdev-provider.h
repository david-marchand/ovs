...
#define NETDEV_TX_OFFLOAD_OFFLOADS() \
NETDEV_TX_OFFLOAD_OFFLOAD(IPV4_CKSUM, ip_csum) \
NETDEV_TX_OFFLOAD_OFFLOAD(TCP_CKSUM, tcp_csum) \
NETDEV_TX_OFFLOAD_OFFLOAD(UDP_CKSUM, udp_csum) \
NETDEV_TX_OFFLOAD_OFFLOAD(SCTP_CKSUM, sctp_csum) \
NETDEV_TX_OFFLOAD_OFFLOAD(TCP_TSO, tcp_seg) \
NETDEV_TX_OFFLOAD_OFFLOAD(VXLAN_TNL_TSO, vxlan_tnl_tso) \
NETDEV_TX_OFFLOAD_OFFLOAD(GENEVE_TNL_TSO, geneve_tnl_tso) \
NETDEV_TX_OFFLOAD_OFFLOAD(IP_TNL_CSUM, ip_tnl_csum) \
NETDEV_TX_OFFLOAD_OFFLOAD(UDP_TNL_CSUM, udp_tnl_csum) \
NETDEV_TX_OFFLOAD_OFFLOAD(GRE_TNL_TSO, gre_tnl_tso)

#define NETDEV_TX_OFFLOAD_OFFLOAD(flag, name) NETDEV_TX_OFFLOAD_ ## flag ## _BIT,
enum netdev_ol_flags_bits {
    NETDEV_TX_OFFLOAD_OFFLOADS()
};
#undef NETDEV_TX_OFFLOAD_OFFLOAD

#define NETDEV_TX_OFFLOAD_OFFLOAD(flag, name) \
    NETDEV_TX_OFFLOAD_ ## flag = 1 << NETDEV_TX_OFFLOAD_ ## flag ## _BIT,
